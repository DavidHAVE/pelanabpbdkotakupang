...
public class CameraInstrumentationTest {
    ...
    @Rule
    public IntentsTestRule<SendReportActivity> intentsRule = new IntentsTestRule<>(SendReportActivity.class);
    ...
    public void validateCameraScenario() {
        ...
        intended(toPackage("com.asus.camera"));
